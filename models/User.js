...
User.prototype.validate = function () {
  return new Promise(async (resolve, reject) => {
    ...
    //if (this.data.username[0] != "S" && this.data.username[1] != "I") {
    //this.error.push("Username should start with SI");
    // }
    if (
      this.data.username != "" &&
    ...
    if (this.data.username.length > 5) {
      this.errors.push("Username cannot exceed 5 characters.");
    }
